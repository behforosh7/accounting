  ...
  if (window.List) {
    ...
    if (lists.length) {
      lists.forEach(function (el) {
        ...
        var listFilter_isactive = document.querySelector('[data-list-filter-isactive]');
        var listFilter_org = document.querySelector('[data-list-filter-org]');
        var listFilter_username = document.querySelector('[data-list-filter-username]');
        var listFilter_mobilenu = document.querySelector('[data-list-filter-mobilenu]');
        var listFilter_lastname = document.querySelector('[data-list-filter-lastname]');
        ...
        if (options.filter) {
          listFilter_isactive.addEventListener('change', function (e) {
            list.filter(function (item) {
              if (e.target.value === '') {
                return true;
              }
              return item.values().is_active.toLowerCase().includes(e.target.value.toLowerCase());
            });
          });
          listFilter_org.addEventListener('change', function (e) {
            list.filter(function (item) {
              if (e.target.value === '') {
                return true;
              }
              return item.values().organization.toLowerCase().includes(e.target.value.toLowerCase());
            });
          });   
          listFilter_username.addEventListener('change', function (e) {
            list.filter(function (item) {
              if (e.target.value === '') {
                return true;
              }
              return item.values().username.toLowerCase().includes(e.target.value.toLowerCase());
            });
          });  
          listFilter_mobilenu.addEventListener('change', function (e) {
            list.filter(function (item) {
              if (e.target.value === '') {
                return true;
              }
              return item.values().mobile_nu.toLowerCase().includes(e.target.value.toLowerCase());
            });
          });  
          listFilter_lastname.addEventListener('change', function (e) {
            list.filter(function (item) {
              if (e.target.value === '') {
                return true;
              }
              return item.values().last_name.toLowerCase().includes(e.target.value.toLowerCase());
            });
          });                                  
        }
      });
...
docReady(productShareDoughnutInit1);
